...
SET dependencies[1].FileName="ImageMagick-7.1.1-41-Q16-HDRI-x64-dll.exe"
...
SET dependencies[2].InstallerUrl="https://github.com/tesseract-ocr/tesseract/releases/download/5.5.0"
SET dependencies[2].FileName="tesseract-ocr-w64-setup-5.5.0.20241111.exe"
...
:CREATE_FILESYSTEM
::
:: Creates the given list of subfolders in the 
